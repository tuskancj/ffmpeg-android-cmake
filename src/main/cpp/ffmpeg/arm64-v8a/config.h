...
#define FFMPEG_CONFIGURATION "--logfile=conflog.txt --enable-small --enable-cross-compile --target-os=linux --enable-shared --disable-static --disable-doc --arch=aarch64 --cpu=armv8-a --enable-runtime-cpudetect --prefix=./android/arm64-v8a --extra-libs=-lgcc --cc=/home/tuskantech/Desktop/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64/bin/aarch64-linux-android-gcc --cross-prefix=/home/tuskantech/Desktop/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64/bin/aarch64-linux-android- --nm=/home/tuskantech/Desktop/android-ndk-r14b/toolchains/aarch64-linux-android-4.9/prebuilt/linux-x86_64/bin/aarch64-linux-android-nm --sysroot=/home/tuskantech/Desktop/android-ndk-r14b/platforms/android-23/arch-arm64/ --enable-gpl --enable-version3 --enable-libx264 --enable-zlib --extra-cflags='-pipe -DANDROID -fasm -O2 -march=armv8-a -mtune=generic' --extra-cxxflags='-pipe -DANDROID -fasm -O2 -march=armv8-a -mtune=generic' --extra-ldflags='-lx264 -lz -Wl,-rpath-link=/home/tuskantech/Desktop/android-ndk-r14b/platforms/android-23/arch-arm64//usr/lib -L/home/tuskantech/Desktop/android-ndk-r14b/platforms/android-23/arch-arm64//usr/lib -nostdlib -lc -lm -ldl -llog' --extra-cflags=-I../x264_builds_ndk-r14b_api23/android/arm64/include --extra-ldflags=-L../x264_builds_ndk-r14b_api23/android/arm64/lib"
