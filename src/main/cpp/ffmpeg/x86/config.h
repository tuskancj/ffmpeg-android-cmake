...
#define FFMPEG_CONFIGURATION "--logfile=conflog.txt --enable-small --enable-cross-compile --target-os=linux --enable-shared --disable-static --disable-doc --arch=x86 --cpu=i686 --enable-runtime-cpudetect --prefix=./android/x86 --extra-libs=-lgcc --cc=/home/tuskantech/Desktop/android-ndk-r14b/toolchains/x86-4.9/prebuilt/linux-x86_64/bin/i686-linux-android-gcc --cross-prefix=/home/tuskantech/Desktop/android-ndk-r14b/toolchains/x86-4.9/prebuilt/linux-x86_64/bin/i686-linux-android- --nm=/home/tuskantech/Desktop/android-ndk-r14b/toolchains/x86-4.9/prebuilt/linux-x86_64/bin/i686-linux-android-nm --sysroot=/home/tuskantech/Desktop/android-ndk-r14b/platforms/android-23/arch-x86/ --enable-gpl --enable-version3 --enable-libx264 --enable-zlib --extra-cflags='-O2 -m32 -mfpmath=sse -fpic -pipe -DANDROID -march=i686 -mtune=generic' --extra-cxxflags='-O2 -m32 -mfpmath=sse -fpic -pipe -DANDROID -march=i686 -mtune=generic' --extra-ldflags='-lx264 -lz -Wl,-rpath-link=/home/tuskantech/Desktop/android-ndk-r14b/platforms/android-23/arch-x86//usr/lib -L/home/tuskantech/Desktop/android-ndk-r14b/platforms/android-23/arch-x86//usr/lib -nostdlib -lc -lm -ldl -llog' --extra-cflags=-I../x264_builds_ndk-r14b_api23/android/x86/include --extra-ldflags=-L../x264_builds_ndk-r14b_api23/android/x86/lib"
